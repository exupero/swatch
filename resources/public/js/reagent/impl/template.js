...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__4921__auto__,writer__4922__auto__,opt__4923__auto__){
return cljs.core._write(writer__4922__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__4323__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__4323__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__4323__auto__)){
return or__4323__auto__;
} else {
...
var G__10349 = o;
(G__10349[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
while (G__10351__i < G__10351__a.length) {G__10351__a[G__10351__i] = arguments[G__10351__i + 0]; ++G__10351__i;}
  args = new cljs.core.IndexedSeq(G__10351__a,0);
} 
...
var old_10353 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_10353))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_10353)].join(''):class$));
} else {
}
...
if(cljs.core.not((function (){var and__4311__auto__ = (node === document.activeElement);
if(and__4311__auto__){
var and__4311__auto____$1 = reagent.impl.template.has_selection_api_QMARK_((node["type"]));
if(cljs.core.truth_(and__4311__auto____$1)){
return (typeof value === 'string') && (typeof node_value === 'string');
} else {
return and__4311__auto____$1;
}
} else {
...
if(cljs.core.truth_((function (){var and__4311__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__10356 = jsprops;
(G__10356["defaultValue"] = value);

(G__10356["onChange"] = ((function (G__10356,v,value,on_change){
return (function (p1__10354_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10354_SHARP_);
});})(G__10356,v,value,on_change))
);
...
var vec__10358 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10358,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10358,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10358,(2),null);
...
var temp__4427__auto__ = (function (){var G__10362 = cljs.core.meta(v);
var G__10362__$1 = (((G__10362 == null))?null:reagent.impl.template.get_key(G__10362));
return G__10362__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__10364_10365 = v;
var G__10364_10366__$1 = (((G__10364_10365 == null))?null:reagent.impl.template.key_from_vec(G__10364_10365));
var G__10364_10367__$2 = (((G__10364_10366__$1 == null))?null:(jsprops["key"] = G__10364_10366__$1));
...
var G__10371 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10371) : reagent.impl.template.as_element.call(null,G__10371));
} else {
var p = (function (){var temp__4427__auto__ = (function (){var G__10372 = cljs.core.meta(argv);
var G__10372__$1 = (((G__10372 == null))?null:reagent.impl.template.get_key(G__10372));
return G__10372__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__10373 = (((jsprops == null))?{}:jsprops);
(G__10373["key"] = key);
...
var G__10374 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__10374;
continue;
}
} else {
...
var n__5226__auto___10375 = a.length;
var i_10376 = (0);
while(true){
if((i_10376 < n__5226__auto___10375)){
(a[i_10376] = reagent.impl.template.as_element((a[i_10376])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__5226__auto___10378 = a.length;
var i_10379 = (0);
while(true){
if((i_10379 < n__5226__auto___10378)){
var val_10380 = (a[i_10379]);
if((cljs.core.vector_QMARK_(val_10380)) && ((reagent.impl.template.key_from_vec(val_10380) == null))){
(o["no-key"] = true);
} else {
}

(a[i_10379] = reagent.impl.template.as_element(val_10380));

var G__10381 = (i_10379 + (1));
i_10379 = G__10381;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__4311__auto__ = cljs.core.not(reagent.impl.component._STAR_non_reactive_STAR_);
if(and__4311__auto__){
return (ctx["no-key"]);
} else {
return and__4311__auto__;
...
var G__10383 = (cljs.core.count(argv) - first_child);
switch (G__10383) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__10383){
